...
-- DropIndex
DROP INDEX "DailyGuesses_userId_date_key";
...
ALTER COLUMN "lastPlayedDate" SET NOT NULL DEFAULT CURRENT_TIMESTAMP;

-- AlterTable
ALTER TABLE "Inventory" ALTER COLUMN "lastPurchaseDate" SET NOT NULL,
ALTER COLUMN "lastPurchaseDate" SET DEFAULT CURRENT_TIMESTAMP;
